...
private struct VeyraUpcomingCard: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 11) {
            ZStack(alignment: .bottom) {
                ...
                HStack(alignment: .bottom) {
                    VeyraPosterBadge(
                        title: item.episodeCode,
                        symbol: "tv",
                        accent: VeyraColors.red,
                        fontSize: 14
                    )
            ...
            .overlay {
                ...
                .stroke(
                    isFocused
                        ? LinearGradient(
                            colors: [VeyraColors.ice, VeyraColors.cyan, VeyraColors.red],
                            startPoint: .leading,
                            endPoint: .trailing
                        )
                        : LinearGradient(
                            colors: [.white.opacity(0.14)],
                            startPoint: .leading,
                            endPoint: .trailing
                        ),
            ...
            .shadow(color: isFocused ? VeyraColors.cyan.opacity(0.30) : .black.opacity(0.34), radius: isFocused ? 20 : 12, x: -5, y: 8)
            .shadow(color: isFocused ? VeyraColors.red.opacity(0.20) : .clear, radius: 18, x: 9, y: 4)
        ...
        .background(
            LinearGradient(
                colors: [
                    Color.white.opacity(isFocused ? 0.10 : 0.045),
        ...
        .overlay {
            RoundedRectangle(cornerRadius: 25, style: .continuous)
                .stroke(.white.opacity(isFocused ? 0.14 : 0.07), lineWidth: 1)
        }
