...
plist = Path.home() / 'Library/LaunchAgents/com.veyra.woonkamer.autodeploy.plist'
plist.parent.mkdir(parents=True, exist_ok=True)
shutil.copyfile('Tools/woonkamer-autodeploy.plist', plist)
...
print('AAN: opgeslagen wijzigingen worden automatisch gebouwd, geïnstalleerd en gestart op Woonkamer.')
